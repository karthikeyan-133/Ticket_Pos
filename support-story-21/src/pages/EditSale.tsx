...
const EditSale = () => {
  ...
  const fetchSale = async () => {
    try {
      ...
      setFormData({
        ...
        productEnquired: saleData.productEnquired || "",
        productPrice: saleData.productPrice?.toString() || "",
        assignedExecutive: saleData.assignedExecutive || "",
        dateOfEnquiry: saleData.dateOfEnquiry?.split('T')[0] || "",
        nextFollowUpDate: saleData.nextFollowUpDate?.split('T')[0] || "",
        lastCallDetails: saleData.lastCallDetails || "",
        statusOfEnquiry: saleData.statusOfEnquiry || "hot",
        documents: saleData.documents || ""
      });
    } catch (error: any) {
      toast({
        title: "Error",
        description: error.message || "Failed to fetch sales enquiry details.",
        variant: "destructive",
      });
  ...
  // Load executives and sale details on component mount
  useEffect(() => {
    fetchExecutives();
    if (id) {
      fetchSale();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Sales enquiry updated successfully.",
      });
      ...
      toast({
        title: "Error",
        description: error.message || "Failed to update sales enquiry.",
        variant: "destructive",
      });
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold text-foreground">Edit Sales Enquiry</h1>
          <p className="text-muted-foreground">
            Update sales enquiry information
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Update the information for this sales enquiry
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-2">
              <Button asChild variant="outline">
                <NavLink to={`/sales/${id}`}>Cancel</NavLink>
              </Button>
